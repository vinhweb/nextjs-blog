      ...
      <header>
        <nav className="flex justify-between items-center py-8 px-4 xl:px-10">
          <Link href="/">
            ...
            <a className="text-lg font-bold">ThamDinhGiaAV.com</a>
          </Link>
      ...
      <footer className="py-10 lg:py-20">
        <div className="container mx-auto px-4 mb-12 md:mb-20">
          <div className="max-w-2xl mx-auto text-center">
            <a className="inline-block mb-8 text-gray-900 text-lg font-semibold" href="#">
              {/* <img className="h-7" src="zeus-assets/logo/logo-zeus-red.svg" alt="" width="auto"/> */}
              ThamDinhGiaAV.com
            </a>
            <ul className="mb-8 flex flex-wrap space-x-8 items-center justify-center text-sm">
              <li className="mb-2 md:mb-0"><a className="font-medium hover:text-gray-600" href="#">Dự án bất động sản</a></li>
              <li className="mb-2 md:mb-0"><a className="font-medium hover:text-gray-600" href="#">Nhà bán</a></li>
              <li className="mb-2 md:mb-0"><a className="font-medium hover:text-gray-600" href="#">Nhà cho thuê</a></li>
              <li className="mb-2 md:mb-0"><a className="font-medium hover:text-gray-600" href="#">Đất</a></li>
            </ul>
            <div className="flex justify-center">
              ...
              <a className="flex justify-center items-center w-10 h-10 bg-gray-50 rounded-full" href="#">
