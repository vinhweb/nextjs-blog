...
import {  forwardRef, useRef, useImperativeHandle , Fragment, useEffect, useState } from 'react'

const Modal = forwardRef((props: {title, message, buttonText}, ref) => {
              ...
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    {message ? message : `Your payment has been successfully submitted. We’ve sent
